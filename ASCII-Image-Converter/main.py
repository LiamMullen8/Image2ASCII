...
print("Enter scale delta: (0-13]")
print("WARNING: Any number above 10 starts to take a while.")
delta = float(input())
...
#greyscale char index coorespond
#write char to img/txt
#once end of row, need to writre newline it doesnt know
for i in range(h):
  for j in range(w):
    (r,g,b) = pix[j,i]
    h = int((r+g+b)/3)
